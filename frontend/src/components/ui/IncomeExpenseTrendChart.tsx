...
import type { IncomeExpenseTrendItem } from "../../api/reports.api";

interface Props {
    data: IncomeExpenseTrendItem[];
}

// ── Recharts Custom Component Types ─────────────────────────────────────────
...
export default function IncomeExpenseTrendChart({
    ...
    const incomeOpacity =
        activeView === "expense" ? 0.15 : 1;

    const expenseOpacity =
        activeView === "income" ? 0.15 : 1;

    return (
        <div
            style={{
                background:
                    "linear-gradient(145deg, #0c0c0f 0%, #09090b 60%, #0d0d10 100%)",
                borderRadius: 24,
                border:
        ...
        >
            ...
            <div
                style={{
                    ...
                    pointerEvents: "none",
                    background:
                        "radial-gradient(ellipse 60% 40% at 30% 0%, rgba(34,197,94,0.04) 0%, transparent 70%), radial-gradient(ellipse 50% 35% at 80% 100%, rgba(239,68,68,0.04) 0%, transparent 70%)",
                }}
            />
